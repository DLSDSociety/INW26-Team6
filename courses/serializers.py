...
#     enrolled_count = serializers.IntegerField(read_only=True, default=0)  # ← ADDED

#     class Meta:
#         model = Course
#         fields = '__all__'
#         # Note: when using fields = '__all__', extra declared fields like
#         # enrolled_count and lessons are automatically included as well.
