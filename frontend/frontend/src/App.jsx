...
// function Dashboard() {
//   return <h1 style={{ padding: "20px" }}>Dashboard Page</h1>;
// }
...
//         } />
//         <Route
//                path="/course/:courseId/learn" element={
//                  <PrivateRoute>
//                  <LessonPage />
//                  </PrivateRoute>
//                  }/>
//          <Route path="/instructor/dashboard" element={<PrivateRoute><InstructorDashboard /></PrivateRoute>} />
//          <Route path="/instructor/create-course" element={<PrivateRoute><CreateCoursePage /></PrivateRoute>} />
//          <Route path="/instructor/add-lesson/:courseId" element={<PrivateRoute><AddLessonPage /></PrivateRoute>} />
//         </Routes>
//     </BrowserRouter>
//   );
// }
